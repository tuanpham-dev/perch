...
A collapsible tree preview for `.json` and `.yaml`/`.yml` files, instead of raw text.
...
Bundled with Perch — disable it from the Extensions view to fall back to plain-text editing for JSON/YAML files.
